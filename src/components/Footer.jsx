      ...
      <div className="container footer-inner">
        <div className="footer-logo">
          <span className="logo-text" style={{
            background: 'linear-gradient(135deg, var(--accent-3), var(--teal))',
        ...
        <p className="footer-copy">
          &copy; {year} Kalisetti Tejaswi. Designed & built with ❤️
        </p>

        <div className="footer-links">
          <a href="https://github.com/sindhutej-6" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
